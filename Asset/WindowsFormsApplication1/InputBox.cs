...
namespace WindowsFormsApplication1
{
	...
	public class InputBox
	{
		...
		private static void InitializeComponent()
		{
			...
			btnRetry.FlatStyle = FlatStyle.Standard;
			btnRetry.Location = new Point(326, 40);
			btnRetry.Name = "btnRetry";
			btnRetry.Size = new Size(64, 24);
			btnRetry.TabIndex = 2;
			btnRetry.Text = "&Retry";
			...
			frmInputDialog.Controls.Add(btnRetry);
        ...
        static public void txtInput_Keydown(object sender, KeyEventArgs e)
        {
		...
		static private void btnRetry_Click(object sender, System.EventArgs e)
		{
            OutputResponse.ReturnCode = DialogResult.Retry;
